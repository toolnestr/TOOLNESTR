...
export const tools = [
  ...
  // ── Clothing & Garment: Cost & Business ──
  { slug: 'cost-per-wear-calculator', title: 'Cost-Per-Wear Calculator', short: 'Find the true cost of a garment per wear from price and wear count.', category: 'clothing', sub: 'Cost & Business', emoji: '💰', enabled: true, status: 'live' },
  { slug: 'garment-costing-calculator', title: 'Garment Manufacturing/Costing Calculator', short: 'Build a full garment cost sheet from fabric, trims, CM, and overhead.', category: 'clothing', sub: 'Cost & Business', emoji: '🧾', enabled: true, status: 'live' },
  { slug: 'clothing-markup-calculator', title: 'Clothing Markup & Retail Price Calculator', short: 'Calculate retail price from wholesale cost and target markup.', category: 'clothing', sub: 'Cost & Business', emoji: '🛍️', enabled: true, status: 'live' },
  { slug: 'fabric-consumption-cost-calculator', title: 'Fabric Consumption-to-Cost Calculator', short: 'Convert fabric consumption per garment into a per-unit fabric cost.', category: 'clothing', sub: 'Cost & Business', emoji: '🧮', enabled: true, status: 'live' },
  { slug: 'wholesale-to-retail-pricing-calculator', title: 'Wholesale-to-Retail Pricing Calculator', short: 'Calculate retail price from wholesale cost using a keystone or custom multiplier.', category: 'clothing', sub: 'Cost & Business', emoji: '📦', enabled: true, status: 'live' },
  { slug: 'custom-garment-price-calculator', title: 'Custom Garment/Order Price Calculator', short: 'Price a custom or made-to-order garment from materials, labor, and margin.', category: 'clothing', sub: 'Cost & Business', emoji: '✏️', enabled: true, status: 'live' },
  { slug: 'alteration-cost-estimator', title: 'Tailoring/Alteration Cost Estimator', short: 'Estimate the cost of common tailoring and alteration jobs.', category: 'clothing', sub: 'Cost & Business', emoji: '🧵', enabled: true, status: 'live' },
  { slug: 'cm-cost-calculator', title: 'Sourcing/CM (Cut-Make) Cost Calculator', short: 'Calculate cut-make labor cost from SMV and cost-per-minute.', category: 'clothing', sub: 'Cost & Business', emoji: '✂️', enabled: true, status: 'live' },
  { slug: 'apparel-shipping-cost-estimator', title: 'Apparel Packaging & Shipping Cost Estimator', short: 'Estimate per-unit packaging and shipping cost for an apparel order.', category: 'clothing', sub: 'Cost & Business', emoji: '🚚', enabled: true, status: 'live' },
  { slug: 'fabric-yield-calculator', title: 'Fabric Bolt-to-Garment Yield Calculator', short: 'Calculate how many garments a fabric bolt will yield.', category: 'clothing', sub: 'Cost & Business', emoji: '🎯', enabled: true, status: 'live' },
  { slug: 'margin-vs-markup-calculator', title: 'Margin vs Markup Calculator', short: 'Convert between profit margin and markup percentage instantly.', category: 'clothing', sub: 'Cost & Business', emoji: '📐', enabled: true, status: 'live' },
  { slug: 'garment-cost-sheet-calculator', title: 'Garment Cost Sheet Calculator', short: 'Build a one-page garment cost sheet from a short list of cost inputs.', category: 'clothing', sub: 'Cost & Business', emoji: '📋', enabled: true, status: 'live' },
  { slug: 'fabric-waste-overrun-calculator', title: 'Fabric Waste & Overrun Calculator', short: 'Calculate fabric waste percentage and cutting overrun needed.', category: 'clothing', sub: 'Cost & Business', emoji: '♻️', enabled: true, status: 'live' },
  { slug: 'cbm-container-loading-calculator', title: 'Carton CBM & Container Loading Estimator', short: 'Calculate carton CBM and how many cartons fit a shipping container.', category: 'clothing', sub: 'Cost & Business', emoji: '🚢', enabled: true, status: 'live' },
  { slug: 'aql-sampling-calculator', title: 'AQL Sampling & Lead Time Estimator', short: 'Find the sample size and accept/reject numbers for an AQL inspection.', category: 'clothing', sub: 'Cost & Business', emoji: '🔍', enabled: true, status: 'live' },
  { slug: 'sam-line-efficiency-calculator', title: 'SAM / Line Efficiency Calculator', short: 'Calculate standard allowed minutes and sewing line efficiency.', category: 'clothing', sub: 'Cost & Business', emoji: '⏱️', enabled: true, status: 'live' },
  ...
  { slug: 'html-sitemap-generator', title: 'XML Sitemap Generator', short: 'Generate XML sitemap from a list of URLs.', category: 'seo', emoji: '🗺️', enabled: true, status: 'live' },
  ...
  { slug: 'paint-coverage-calculator', title: 'Paint Coverage Calculator', short: 'Estimate how many gallons of paint you need for any room.', category: 'construction', sub: 'Home & Garden', emoji: '🎨', enabled: true, status: 'live' },
  ...
  { slug: 'square-footage-calculator', title: 'Square Footage Calculator', short: 'Area of a room or lot from length and width.', category: 'construction', sub: 'Converters', emoji: '📐', enabled: true, status: 'live' },
  { slug: 'perimeter-calculator', title: 'Perimeter Calculator', short: 'Perimeter of rectangles, circles, and triangles.', category: 'construction', sub: 'Converters', emoji: '📏', enabled: true, status: 'live' },
  { slug: 'concrete-calculator', title: 'Concrete Calculator', short: 'Cubic yards of concrete needed for a slab.', category: 'construction', sub: 'Cement & Concrete', emoji: '🏗️', enabled: true, status: 'live' },
  { slug: 'concrete-slab-calculator', title: 'Concrete Slab Calculator', short: 'Concrete needed for flat slabs with waste buffer.', category: 'construction', sub: 'Cement & Concrete', emoji: '🧱', enabled: true, status: 'live' },
  { slug: 'tile-calculator', title: 'Tile Calculator', short: 'Tiles needed for a room from area and tile size.', category: 'construction', sub: 'Materials', emoji: '⬜', enabled: true, status: 'live' },
  { slug: 'flooring-calculator', title: 'Flooring Calculator', short: 'Flooring material needed with estimated cost.', category: 'construction', sub: 'Home & Garden', emoji: '🪵', enabled: true, status: 'live' },
  { slug: 'brick-calculator', title: 'Brick Calculator', short: 'Bricks needed for a wall from dimensions.', category: 'construction', sub: 'Materials', emoji: '🧱', enabled: true, status: 'live' },
  { slug: 'fence-calculator', title: 'Fence Calculator', short: 'Posts, rails, and panels for a fence run.', category: 'construction', sub: 'Home & Garden', emoji: '🚧', enabled: true, status: 'live' },
  { slug: 'deck-calculator', title: 'Deck Calculator', short: 'Decking boards and joists from dimensions.', category: 'construction', sub: 'Home & Garden', emoji: '🪵', enabled: true, status: 'live' },
  { slug: 'roofing-calculator', title: 'Roofing Calculator', short: 'Roofing squares and shingle bundles needed.', category: 'construction', sub: 'Roofing', emoji: '🏠', enabled: true, status: 'live' },
  { slug: 'gravel-sand-calculator', title: 'Gravel & Sand Calculator', short: 'Cubic yards of gravel or sand for a area.', category: 'construction', sub: 'Materials', emoji: '⛰️', enabled: true, status: 'live' },
  { slug: 'mulch-calculator', title: 'Mulch Calculator', short: 'Cubic yards of mulch for garden beds.', category: 'construction', sub: 'Home & Garden', emoji: '🌿', enabled: true, status: 'live' },
  { slug: 'board-foot-lumber-calculator', title: 'Board Foot / Lumber Calculator', short: 'Board feet from lumber dimensions.', category: 'construction', sub: 'Materials', emoji: '🪵', enabled: true, status: 'live' },
  { slug: 'pool-volume-calculator', title: 'Pool Volume Calculator', short: 'Gallons in a pool from shape and depth.', category: 'construction', sub: 'Water & Vessels', emoji: '🏊', enabled: true, status: 'live' },
  { slug: 'cubic-yardage-calculator', title: 'Cubic Yardage Calculator', short: 'Volume to cubic yards converter.', category: 'construction', sub: 'Converters', emoji: '📦', enabled: true, status: 'live' },
  { slug: 'drywall-calculator', title: 'Drywall Calculator', short: 'Drywall sheets needed for a room.', category: 'construction', sub: 'Materials', emoji: '🧱', enabled: true, status: 'live' },
  { slug: 'insulation-calculator', title: 'Insulation Calculator', short: 'R-value coverage and rolls required.', category: 'construction', sub: 'Home & Garden', emoji: '🛡️', enabled: true, status: 'live' },
  ...
  // ── Construction Batch 3: Home & Garden ──
  { slug: 'ac-size-calculator', title: 'AC Unit Size Calculator', short: 'AC tonnage from square footage and climate.', category: 'construction', sub: 'Home & Garden', emoji: '❄️', enabled: true, status: 'live' },
  { slug: 'furnace-btu-calculator', title: 'Furnace BTU Calculator', short: 'Furnace size from square footage and insulation.', category: 'construction', sub: 'Home & Garden', emoji: '🔥', enabled: true, status: 'live' },
  { slug: 'heat-loss-calculator', title: 'Home Heat Loss Estimator', short: 'Heat loss through a surface by R-value and ΔT.', category: 'construction', sub: 'Home & Garden', emoji: '🌡️', enabled: true, status: 'live' },
  { slug: 'fence-post-spacing-calculator', title: 'Fence Post Spacing Calculator', short: 'Post count and hole depth below the frost line.', category: 'construction', sub: 'Home & Garden', emoji: '🚧', enabled: true, status: 'live' },
  { slug: 'deck-stain-calculator', title: 'Deck Stain Calculator', short: 'Gallons of stain by deck area and railing.', category: 'construction', sub: 'Home & Garden', emoji: '🖌️', enabled: true, status: 'live' },
  ...
  { slug: 'bacterial-growth-rate-calculator', title: 'Bacterial Growth Rate Calculator', short: 'k = ln(Nt/N0)/t — exponential growth rate constant.', category: 'biology', emoji: '⏱️', enabled: true, status: 'live' },
  { slug: 'generation-time-calculator', title: 'Generation (Doubling) Time Calculator', short: 'g = t/n — average generation time from population counts.', category: 'biology', emoji: '⏳', enabled: true, status: 'live' },
  { slug: 'serial-dilution-calculator', title: 'Serial Dilution Calculator', short: 'Per-step and cumulative dilution factor across a series.', category: 'biology', emoji: '🌊', enabled: true, status: 'live' },
  { slug: 'cfu-per-ml-calculator', title: 'CFU per mL Calculator', short: 'Colony forming units from plate count and dilution.', category: 'biology', emoji: '🥼', enabled: true, status: 'live' },
  { slug: 'microbial-growth-curve-calculator', title: 'Microbial Growth Curve Plotter', short: 'Model lag, log, stationary, and death growth phases.', category: 'biology', emoji: '📉', enabled: true, status: 'live' },
  { slug: 'energy-pyramid-calculator', title: 'Energy Pyramid / 10% Rule Calculator', short: 'Energy transfer efficiency across trophic levels.', category: 'biology', emoji: '⚡', enabled: true, status: 'live' },
  { slug: 'mark-recapture-calculator', title: 'Mark-Recapture Population Estimator', short: 'Lincoln-Petersen index — estimate wildlife population size.', category: 'biology', emoji: '🏷️', enabled: true, status: 'live' },
  { slug: 'biomass-calculator', title: 'Biomass Calculator', short: 'Total biomass from population/density and average mass.', category: 'biology', emoji: '🪵', enabled: true, status: 'live' },
  { slug: 'osmosis-tonicity-calculator', title: 'Osmosis/Tonicity Predictor', short: 'Predict water movement and cell outcome from tonicity.', category: 'biology', emoji: '💦', enabled: true, status: 'live' },
  { slug: 'cell-doubling-time-calculator', title: 'Cell Doubling Time Calculator', short: 'Doubling time and PDL for mammalian cell culture.', category: 'biology', emoji: '🔁', enabled: true, status: 'live' },
  { slug: 'speciation-rate-calculator', title: 'Speciation Rate Estimator', short: "r = ln(N/N0)/t — a clade's net diversification rate.", category: 'biology', emoji: '🌿', enabled: true, status: 'live' },
  { slug: 'hardy-weinberg-equilibrium-checker', title: 'Hardy-Weinberg Equilibrium Checker', short: 'Chi-square test comparing observed vs. expected genotypes.', category: 'biology', emoji: '📋', enabled: true, status: 'live' },
  { slug: 'natural-selection-calculator', title: 'Natural Selection Simulator', short: 'Allele frequency change over generations under selection.', category: 'biology', emoji: '🦎', enabled: true, status: 'live' },
  { slug: 'predator-prey-calculator', title: 'Predator-Prey (Lotka-Volterra) Simulator', short: 'Population cycles and equilibrium from the Lotka-Volterra model.', category: 'biology', emoji: '🐺', enabled: true, status: 'live' },
  { slug: 'protein-molecular-weight-calculator', title: 'Protein Molecular Weight Calculator', short: 'Sum residue masses from a protein sequence.', category: 'biology', emoji: '⚗️', enabled: true, status: 'live' },
  { slug: 'amino-acid-sequence-analyzer', title: 'Amino Acid Sequence Analyzer', short: 'Composition, hydrophobicity, and charge from a sequence.', category: 'biology', emoji: '🧵', enabled: true, status: 'live' },
  { slug: 'ph-enzyme-activity-calculator', title: 'pH-Enzyme Activity Simulator', short: 'Model enzyme activity across a range of pH.', category: 'biology', emoji: '🧴', enabled: true, status: 'live' },
  { slug: 'photosynthesis-rate-calculator', title: 'Photosynthesis Rate Calculator', short: 'O2 output vs. light intensity, saturation curve.', category: 'biology', emoji: '☀️', enabled: true, status: 'live' },
  { slug: 'cellular-respiration-calculator', title: 'Cellular Respiration Equation Balancer', short: 'Glucose oxidation stoichiometry and ATP yield.', category: 'biology', emoji: '🫁', enabled: true, status: 'live' },
  { slug: 'genetic-drift-calculator', title: 'Genetic Drift Simulator', short: 'Heterozygosity decay and simulated allele-frequency drift.', category: 'biology', emoji: '🎲', enabled: true, status: 'live' },
  { slug: 'mitosis-stage-identifier', title: 'Mitosis Stage Identifier', short: 'Identify prophase, metaphase, anaphase, or telophase.', category: 'biology', emoji: '🔀', enabled: true, status: 'live' },
  { slug: 'pedigree-chart-analyzer', title: 'Pedigree Chart Analyzer', short: 'Infer inheritance mode from a pedigree pattern.', category: 'biology', emoji: '🌳', enabled: true, status: 'live' },
  { slug: 'phylogenetic-tree-builder', title: 'Simple Phylogenetic Tree Builder', short: 'Build a UPGMA tree from a binary character matrix.', category: 'biology', emoji: '🌲', enabled: true, status: 'live' },
