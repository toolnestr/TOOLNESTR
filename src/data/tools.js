...
export const tools = [
  ...
  { slug: 'apparel-shipping-cost-estimator', title: 'Packaging & Shipping Cost Estimator', short: 'Estimate per-unit packaging and shipping cost for an apparel order.', category: 'clothing', sub: 'Cost & Business', emoji: '🚚', enabled: true, status: 'live' },
  ...
  { slug: 'garment-cost-sheet-calculator', title: 'Quick Cost Sheet Calculator', short: 'Build a one-page garment cost sheet from a short list of cost inputs.', category: 'clothing', sub: 'Cost & Business', emoji: '📋', enabled: true, status: 'live' },
