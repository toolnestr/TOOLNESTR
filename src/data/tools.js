...
export const tools = [
  ...
  { slug: 'molarity-calculator', title: 'Molarity Calculator', short: 'M = mol/L — solve for any variable.', category: 'engineering', emoji: '🧪', enabled: true, status: 'live' },
  { slug: 'ideal-gas-law-calculator', title: 'Ideal Gas Law Calculator', short: 'PV=nRT — solve for any one variable.', category: 'engineering', emoji: '🫧', enabled: true, status: 'live' },
  ...
  { slug: 'projectile-motion-calculator', title: 'Projectile Motion Calculator', short: 'Range, height, and time from launch speed.', category: 'engineering', emoji: '🎯', enabled: true, status: 'live' },
