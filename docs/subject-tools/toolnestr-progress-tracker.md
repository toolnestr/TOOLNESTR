...
| Shared component library (one kit reused across all 150 tools) | ✅ Locked — see spec Section 13 — **not yet built** |
...
| 2–50 | (see spec Section 8 for full list) | Not started | Shared component kit to be extracted from this pilot once the pilot is approved. |
